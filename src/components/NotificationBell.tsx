...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 right-0 w-80 bg-card text-card-foreground rounded-xl shadow-xl p-4 z-[201] border border-border max-h-[400px] overflow-hidden flex flex-col">
